		...
		<div class="col-lg-8 tb-cart-form">
			...
			<div class="cart-bottom clearfix" class="actions">
				...
				<div class="update-cart pull-right">
					...
					<input type="submit" class="btn btn-default update<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' '.wc_wp_theme_get_element_class_name('button') : ''); ?>" name="update_cart" value="<?php esc_attr_e('Update Cart', 'diza'); ?>" />
				</div>
			...
			<div class="coupon">
				...
				<div class="box"><input type="text" name="coupon_code" id="coupon_code" value="" class="text" placeholder="<?php esc_attr_e('Enter coupon code here...', 'diza'); ?>" /><input type="submit" class="btn btn-default<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' '.wc_wp_theme_get_element_class_name('button') : ''); ?>" name="apply_coupon" value="<?php esc_attr_e('Apply', 'diza'); ?>" /></div>
